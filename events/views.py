    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if event_reg:
                ...
                message = "You are successfully registered for the event, Area 1 Agm of Round Table India  'Black and White'. Your registration ID is : " + event_reg.qrcode + " And you have paid Rs." + str(
